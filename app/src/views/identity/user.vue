<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-button v-if="hasPermission('Api.Users.Create')" class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleAdd">
        新增用户
      </el-button>
    </div>
    ...
    <el-table v-loading="listLoading" :data="userList" style="width: 100%;margin-top:30px;" border>
      ...
      <el-table-column align="center" label="新增时间">
        <template slot-scope="{row}">
          {{ dateFormat(row.creationTime,'YYYY-MM-DD HH:mm:ss') }}
        </template>
      </el-table-column>
      <el-table-column align="center" label="是否启用">
        <template slot-scope="{row}">
          <el-switch
            ...
            active-color="#13ce66"
            :disabled="row.isStatic||!hasPermission('Api.Users.Update')"
      ...
      <el-table-column align="center" label="操作" width="300">
        <template slot-scope="scope">
          <el-button v-if="!scope.row.isStatic&&hasPermission('Api.Users.Update')" type="primary" size="small" @click="handleEdit(scope)">编辑</el-button>
          <el-button v-if="!scope.row.isStatic&&hasPermission('Api.Users.SetRoles')" type="primary" size="small" @click="handleSetRoles(scope)">设置角色</el-button>
        </template>
      </el-table-column>
    </el-table>
